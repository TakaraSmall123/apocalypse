...
//         this.state.getMoviesByGenre = this.stategetMoviesByGenre.bind(this);
//     }
...
// input onsubmit={this.getMoviesByGenre}


// THIS IS THE PRIMARY


// ANOTHER VERSION OF THE ORIGINAL VERSION
...
//             }
//         }).then((movieList) => {
//             console.log('yo, this is new click', movieList);
//             this.setState({
...
//      handleClickNuclear() {
//            console.log('you picked nuclear');
//     }

//     handleClickAlien() {
//            console.log('you picked alien');
//     }
//     render() {
//         return (
//         	<div>
...
// //             }
// //         }).then((movieList) => {
// //             // console.log('yo, this is the zombie list', movieList);
// //             this.setState({

// //                     movie: movies.movieList.results
// //                 });
// //             console.log('this is setState');
// //         });
...
//             }
//         }).then((movieList) => {
//             console.log('yo, this is the nuclear list', movieList);
//             // this.setState({
//             //         movie: movieList
//             //     });
//         });
...
//             }
//         }).then((movieList) => {
//             console.log('yo, this is the alien list', movieList);
//             // this.setState({
//             //         movie: movieList
//             //     });
//         });
